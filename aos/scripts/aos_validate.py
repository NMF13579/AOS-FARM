...
def build_validation_commands(conditional_scope_contract=None):
...
def main():
    ...
    commands_to_run = build_validation_commands(conditional_scope_contract)
    if args.target != "all":
    ...
    if invalid_context_reason:
        ...
        for cmd in commands_to_run:
            res = run_command(cmd)
            results.append(annotate_conditional_scope_result(res, conditional_scope_contract))
