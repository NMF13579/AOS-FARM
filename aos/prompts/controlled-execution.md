...
1. the required control sources exist and are readable:
   - 00_AOS_Core_Control.md
   - 01_AOS_Assembly_Pipelines_and_Build_Roadmap.md
   - 02_AOS_Governance_Control_Module_and_Safety_Rules.md
2. the current branch and repository state are safe enough for this task;
3. Human Execution Authorization exists for this exact brief;
4. the Risk Profile was assigned by a human;
5. allowed scope is explicit;
6. forbidden scope is explicit.
