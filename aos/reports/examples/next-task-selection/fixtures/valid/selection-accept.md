...
# Valid Selection Accept Fixture

candidate_task_id: GENERIC-TASK.FIXTURE.SELECTION.ACCEPT
...
decision_rationale: Candidate may move to Task Brief draft preparation only.
