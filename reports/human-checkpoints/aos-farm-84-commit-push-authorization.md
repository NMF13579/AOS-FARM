# AOS-FARM.86 — Human Push Authorization for AOS-FARM.84 Commit

## 1. Checkpoint Metadata

```yaml
checkpoint_id: AOS-FARM.86-AOS-FARM.84-COMMIT-PUSH-AUTHORIZATION
...
target_branch: dev
created_for_task: AOS-FARM.86
prepared_by_task: AOS-FARM.85
depends_on_package: reports/aos-farm-84-commit-push-authorization-package.md

human_decision: APPROVED
human_author: "Muhammed"
human_author_is_human: true
human_author_date: "2026-06-14"
human_signature_token: "APPROVED_AOS_FARM_86_AOS_FARM_84_COMMIT_PUSH_BY_MUHAMMED_2026-06-14"
```

## 2. Human Decision

I, Muhammed, explicitly approve push authorization for the exact local AOS-FARM.84 commit listed in this checkpoint.
...
authorized_push_task: AOS-FARM.87
authorized_push_command: "git push origin dev"
authorized_commit_to_push: "1f3fb3a6ec0387a1eb7648270700fd0b9ed031eb"
...
```yaml
authorized_commit_sha: "1f3fb3a6ec0387a1eb7648270700fd0b9ed031eb"
authorized_commit_message: "docs: record aos-farm 78-81 evidence artifacts"
commit_created_by_task: AOS-FARM.84
...
## 7. Required Preconditions for AOS-FARM.87

Before executing the authorized push, AOS-FARM.87 must verify:

```yaml
required_branch: "dev"
required_head_sha: "1f3fb3a6ec0387a1eb7648270700fd0b9ed031eb"
required_origin_dev_sha_before_push: "6d798c4c34cba8b1ebea7a697768c05754acbfe1"
required_dev_ahead_origin_dev_by: 1
required_push_package_exists: true
required_push_package_path: "reports/aos-farm-84-commit-push-authorization-package.md"
required_human_checkpoint_exists: true
required_human_checkpoint_path: "reports/human-checkpoints/aos-farm-84-commit-push-authorization.md"
```

If any required precondition is missing, mismatched, UNKNOWN, or NOT_RUN, AOS-FARM.87 must stop with BLOCKED or HUMAN_REVIEW_REQUIRED.
...
authorized_next_task: "AOS-FARM.87 — Push AOS-FARM.84 Commit"
...
I authorize AOS-FARM.87 to push exactly commit `1f3fb3a6ec0387a1eb7648270700fd0b9ed031eb` from local `dev` to `origin/dev` using exactly:
